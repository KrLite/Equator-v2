...
public record Quaternion(double x, double y, double z, double w) {
	...
	public static Quaternion from(net.minecraft.util.math.Quaternion quaternion) {
	...
	public net.minecraft.util.math.Quaternion toMinecraft() {
		return new net.minecraft.util.math.Quaternion((float) x(), (float) y(), (float) z(), (float) w());
	}
