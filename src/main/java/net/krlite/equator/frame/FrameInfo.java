...
public class FrameInfo {
	public static class Scaled {
		...
		public static class Number {
			public static double width() {
				return FrameInfo.Scaled.width().magnitude();
			}

			public static double height() {
				return FrameInfo.Scaled.height().magnitude();
			}

			public static double size() {
				return FrameInfo.Scaled.size().magnitude();
			}

			public static double xCenter() {
				return FrameInfo.Scaled.center().x();
			}

			public static double yCenter() {
				return FrameInfo.Scaled.center().y();
			}

			public static double xCursor() {
				return FrameInfo.Scaled.cursor().x();
			}

			public static double yCursor() {
				return FrameInfo.Scaled.cursor().y();
			}
		}
	}
	...
	public static class Screen {
		...
		public static class Number {
			public static double width() {
				return FrameInfo.Screen.width().magnitude();
			}

			public static double height() {
				return FrameInfo.Screen.height().magnitude();
			}

			public static double size() {
				return FrameInfo.Screen.size().magnitude();
			}

			public static double xCenter() {
				return FrameInfo.Screen.center().x();
			}

			public static double yCenter() {
				return FrameInfo.Screen.center().y();
			}

			public static double xCursor() {
				return FrameInfo.Screen.cursor().x();
			}

			public static double yCursor() {
				return FrameInfo.Screen.cursor().y();
			}
		}
	}
