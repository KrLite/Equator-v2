...
public class Flat extends Basic {
	...
	public class Rectangle implements Renderable {
		...
		private enum State {
			...
			private final @Nullable Supplier<Shader> shaderProgram;

			State(@Nullable VertexFormat vertexFormat, @Nullable Supplier<Shader> shaderProgram) {
			...
			public @Nullable Supplier<Shader> shaderProgram() {
